...
public static class ConfigurableJointExtensions
{
                                              ...
                                              Quaternion startLocalRotation)
    {
        ...
        {
            Debug.LogError("SetTargetRotationLocal should not be used with joints that are configured in world " +
                               "space. For world space joints, use SetTargetRotation.",
                           joint);
        }
                                         ...
                                         Quaternion startWorldRotation)
    {
        if (!joint.configuredInWorldSpace)
        {
            Debug.LogError("SetTargetRotation must be used with joints that are configured in world space. For local " +
                               "space joints, use SetTargetRotationLocal.",
                           joint);
        }
